...
<html lang="ja">
    ...
    <body>
        ...
        <form id="registerForm" method="post" action="regist_confirm.php">
            ...
            <div>
                <label>名前（名）</label>
                <input type="text" class="text" name="last_name" maxlength="10" pattern="[\u3040-\u309F\u4E00-\u9FAF]+" value="<?= htmlspecialchars($data["last_name"] ?? '') ?>">
            ...
            <div>
                <label>カナ（姓）</label>
                <input type="text" class="text" name="family_name_kana" maxlength="10" pattern="[\u30A0-\u30FF]+" value="<?= htmlspecialchars($data["family_name_kana"] ?? '') ?>">
            ...
            <div>
                <label>カナ（名）</label>
                <input type="text" class="text" name="last_name_kana" maxlength="10" pattern="[\u30A0-\u30FF]+" value="<?= htmlspecialchars($data["last_name_kana"] ?? '') ?>">
            ...
            <div>
                <label>パスワード</label>
                <input type="text" class="text" name="password" maxlength="100" pattern="[A-Za-z0-9]+" value="<?= htmlspecialchars($data["password"] ?? '') ?>">
            ...
            <div>
                <label>郵便番号</label>
                <input type="text" class="text" name="postal_code" maxlength="7" pattern="\d{7}" value="<?= htmlspecialchars($data["postal_code"] ?? '') ?>">
